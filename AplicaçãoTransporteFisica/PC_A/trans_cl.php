...
if ($protocolo == UDP) {
    ...
    deletar('aux.tmp0');
    if (strcmp (OK, substr($resposta, 0, -1)) == 0){
      // ------- Solicita arquivo
      echo "*** Camada de Transporte **" . PHP_EOL;
      echo "Conexão estabelecida com sucesso!... Enviando requisição de mensagem..." . PHP_EOL;
      divideMensagem();                                   // Divide em segmentos
      deletar(MENSAGEM);
      chamarCamadaRede();                      // Ja escreveu os segmentos em arquivos e chama a rede
      ...
      echo "*** Camada de Transporte **" . PHP_EOL;
      echo "Falha ao estabelecer conexão!" . PHP_EOL;
      die;
    }
}
?>
